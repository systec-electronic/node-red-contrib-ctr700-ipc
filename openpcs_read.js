...
module.exports = function(RED)
{
    ...
    RED.nodes.registerType ('openpcs read', OpenPCS_Read_Node);
    ...
    function  OpenPCS_Read_Node (NodeConfig_p)
    {
        ...
        ThisNode.on ('input', OpenPCS_Read_NodeHandler_OnInput);
        ...
        function  OpenPCS_Read_NodeHandler_OnOpen (NodeConfig_p)
        {
            ...
            TraceMsg ('{OpenPCS_Read_Node} creating...');
            ...
            TraceMsg ('{OpenPCS_Read_Node} strVarPath:       ' + strVarPath);
            TraceMsg ('{OpenPCS_Read_Node} strVarType:       ' + strVarType);
            TraceMsg ('{OpenPCS_Read_Node} fAltTopic:        ' + fAltTopic);
            TraceMsg ('{OpenPCS_Read_Node} strAltTopic:      ' + strAltTopic);
            TraceMsg ('{OpenPCS_Read_Node} strIpcStatIndLvl: ' + strIpcStatIndLvl);
            TraceMsg ('{OpenPCS_Read_Node} strNewDataPeriod: ' + strNewDataPeriod);
            TraceMsg ('{OpenPCS_Read_Node} strName:          ' + strName);
            ...
            // get topic for publishing variable value message
            ThisNode.m_strTopic = OpenPCS_Read_BuildTopicString (ThisNode.m_strVarPath, fAltTopic, strAltTopic);
            TraceMsg ('{OpenPCS_Read_Node} m_strTopic: ' + ThisNode.m_strTopic);

            // get IPC status indication level
            ThisNode.m_iIpcStatIndLvl = OpenPCS_Read_GetIpcStatusIndicationLevel (strIpcStatIndLvl);
            TraceMsg ('{OpenPCS_Read_Node} m_iIpcStatIndLvl: ' + ThisNode.m_iIpcStatIndLvl);

            // get timer period for IPC "new data" indication
            ThisNode.m_iNewDataPeriod = OpenPCS_Read_GetIpcNewDataIndicationPeriod (strNewDataPeriod);
            TraceMsg ('{OpenPCS_Read_Node} m_iNewDataPeriod: ' + ThisNode.m_iNewDataPeriod);
            ...
            TraceMsg ('{OpenPCS_Read_Node} new Ipc.IpcClientSingleton');
            ...
            TraceMsg ('{OpenPCS_Read_Node} ObjIpcClient.subscribeEvents()');
            try
            {
                ThisNode.m_EventSubscript = ThisNode.m_ObjIpcClient.subscribeEvents (OpenPCS_Read_CbHandlerStatusEvent);
            }
            catch (ErrInfo)
            {
                TraceMsg ('{OpenPCS_Read_Node} ERROR: ' + ErrInfo.message);

                // show IPC state in editor
                OpenPCS_Read_ShowIpcState (IPC_STATE_ERROR, ErrInfo.message);
            }


            // create variable runtime instance
            ThisNode.m_ObjVarInst = OpenPCS_Read_GetVariableObject (ThisNode.m_strVarPath, ThisNode.m_strVarType);
            if (ThisNode.m_ObjVarInst == null)
            {
                TraceMsg ('{OpenPCS_Read_Node} ERROR: ThisNode.m_ObjVarInst == null');

                // show IPC state in editor
                OpenPCS_Read_ShowIpcState (IPC_STATE_ERROR);
                return;
            }

            // register variable runtime instance to IPC object instance
            TraceMsg ('{OpenPCS_Read_Node} ObjIpcClient.register (' + ThisNode.m_strVarPath + ')');
            try
            {
            ...
            TraceMsg ('{OpenPCS_Read_Node} ObjVarInst.subscribeTypeMatch (' + ThisNode.m_strVarPath + ')');
            try
            {
                ThisNode.m_ObjVarInst.subscribeTypeMatch (OpenPCS_Read_CbHandlerTypeMatch);
            }
            catch (ErrInfo)
            {
                TraceMsg ('{OpenPCS_Read_Node} ERROR: ' + ErrInfo.message);
            ...
            TraceMsg ('{OpenPCS_Read_Node} ObjVarInst.subscribe (' + ThisNode.m_strVarPath + ')');
            try
            {
                ThisNode.m_VarSubscript = ThisNode.m_ObjVarInst.subscribe (OpenPCS_Read_CbHandlerVarValueChanged, OpenPCS_Read_CbHandlerVarError);
            }
            catch (ErrInfo)
            {
                TraceMsg ('{OpenPCS_Read_Node} ERROR: ' + ErrInfo.message);
            ...
            // publishing initial input channel state is done in callback function 'OpenPCS_Read_CbHandlerVarValueChanged()'
        ...
        function  OpenPCS_Read_NodeHandler_OnInput (Msg_p)
        {
        ...
        function  OpenPCS_Read_NodeHandler_OnNodesStarted ()
        {
        ...
        function  OpenPCS_Read_CbHandlerStatusEvent (strEvent_p)
        {

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerStatusEvent: strEvent_p=' + strEvent_p);
            ...
            switch (strEvent_p)
            {
                case 'START':
                {
                    TraceMsg (' ');
                    TraceMsg (' ');
                    TraceMsg ('{OpenPCS_Read_Node} PLC state switched to RUN');
                    TraceMsg (' ');
                    TraceMsg (' ');
                ...
                case 'STOP':
                {
                    TraceMsg (' ');
                    TraceMsg (' ');
                    TraceMsg ('{OpenPCS_Read_Node} PLC state switched to STOP');
                    TraceMsg (' ');
                    TraceMsg (' ');

                    // cleares the status entry initially from the node
                    OpenPCS_Read_ShowIpcState (IPC_STATE_PLC_STOP);
                ...
                default:
                {
                    TraceMsg ('{OpenPCS_Read_Node} ERROR: OpenPCS_Read_CbHandlerStatusEvent() - unknown event type');
                    break;
                }
            }
        ...
        function  OpenPCS_Read_CbHandlerTypeMatch (ObjVarInst_p, fSuccess_p, Error_p)
        {

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerTypeMatch: ObjVarInst_p.name()=' + ObjVarInst_p.name());

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerTypeMatch: fSuccess_p=' + fSuccess_p);
            if (fSuccess_p != true)
            {
                TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerTypeMatch: Error_p.message=' + Error_p.message + ', Error_p.code=' + Error_p.code);

                // show IPC state in editor
                OpenPCS_Read_ShowIpcState (IPC_STATE_ERROR, Error_p.message);
            }
        ...
        function  OpenPCS_Read_CbHandlerVarValueChanged (ObjVarInst_p, VarValue_p)
        {

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerVarValueChanged: ObjVarInst_p.name()=' + ObjVarInst_p.name() + ', VarValue_p=' + VarValue_p);

            OpenPCS_Read_PublishInputVarValueChanged (ObjVarInst_p, VarValue_p);
        ...
        function  OpenPCS_Read_CbHandlerVarError (ObjVarInst_p, Error_p)
        {

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerVarError: ObjVarInst_p.name()=' + ObjVarInst_p.name() + ', Error_p.message=' + Error_p.message + ', Error_p.code=' + Error_p.code);
        ...
        function  OpenPCS_Read_GetVariableObject (strVarPath_p, strVarType_p)
        {

            var VarTypeClass;
            var ObjVarInst;

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: strVarPath_p=' + strVarPath_p + ', strVarType_p=' + strVarType_p);

            switch (strVarType_p)
            {
                case 'VARTYPE_AUTO':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarAuto');
                    try
                    {
                ...
                case 'VARTYPE_STRING':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarString');
                ...
                case 'VARTYPE_BOOL':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarBool');
                ...
                case 'VARTYPE_BYTE':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarByte');
                ...
                case 'VARTYPE_USINT':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarUSInt');
                ...
                case 'VARTYPE_SINT':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarSInt');
                ...
                case 'VARTYPE_WORD':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarWord');
                ...
                case 'VARTYPE_UINT':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarUInt');
                ...
                case 'VARTYPE_INT':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarInt');
                ...
                case 'VARTYPE_DWORD':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarDWord');
                ...
                case 'VARTYPE_UDINT':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarUDInt');
                ...
                case 'VARTYPE_DINT':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarDInt');
                ...
                case 'VARTYPE_REAL':
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ObjVarInst=IpcVarReal');
                ...
                default:
                {
                    TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_GetVariableObject: ERROR: unknown/unsupported Type (ObjVarInst=null)');
                    ObjVarInst = null;
                    break;
                }
            }
        ...
        //-------------------------------------------------------------------
        //  Private: Publish variable value changes
        //-------------------------------------------------------------------

        function  OpenPCS_Read_PublishInputVarValueChanged (ObjVarInst_p, VarValue_p)
        {

            var Msg = { topic: '', payload: 0 };

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_PublishInputVarValueChanged: ObjVarInst_p.name()=' + ObjVarInst_p.name());

            // check if received variable changes matches to configured variable path
            if (ObjVarInst_p.name() != ThisNode.m_strVarPath)
            {
                // mismatch in variable path -> abort processing
                TraceMsg ('{OpenPCS_Read_Node} ERROR: Variable Path Mismatch (' + ObjVarInst_p.name() + ' <> ' + ThisNode.m_strVarPath + ') -> Ignore Message');
                return;
            }

            // show IPC state in editor
            OpenPCS_Read_ShowIpcState (IPC_STATE_ACTIVE);

            // send message
            Msg.topic   = ThisNode.m_strTopic;
            Msg.payload = VarValue_p;
            TraceMsg ('{OpenPCS_Read_Node} SendMsg (topic=' + Msg.topic + ', payload=' + Msg.payload.toString() + ')');
            ThisNode.send (Msg);
        ...
        function  OpenPCS_Read_CbHandlerStatusTimer (iStatusTimerInst_p)
        {

            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_CbHandlerStatusTimer (' + iStatusTimerInst_p + ')');
        ...
        function  OpenPCS_Read_ShowIpcState (iIpcState_p, strErrorInfo_p)
        {
            ...
            TraceMsg ('{OpenPCS_Read_Node} OpenPCS_Read_ShowIpcState: iIpcState_p=' + iIpcState_p + ', m_iIpcStatIndLvl=' + ThisNode.m_iIpcStatIndLvl);
            ...
            switch (iIpcState_p)
            {
                ...
                case IPC_STATE_ACTIVE:
                {
                    ...
                    if ( ThisNode.m_ObjStatusTimer )
                    {
                        ...
                        TraceMsg ('{OpenPCS_Read_Node} clearTimeout()');
                        clearTimeout (ThisNode.m_ObjStatusTimer);
                    }
                    TraceMsg ('{OpenPCS_Read_Node} setTimeout (' + ThisNode.m_iNewDataPeriod + ', ' + ThisNode.m_iStatusTimerInst + ')');
                    ThisNode.m_ObjStatusTimer = setTimeout (OpenPCS_Read_CbHandlerStatusTimer, ThisNode.m_iNewDataPeriod, ThisNode.m_iStatusTimerInst);
        ...
        function  OpenPCS_Read_GetIpcStatusIndicationLevel (strIpcStatIndLvl_p)
        {
        ...
        function  OpenPCS_Read_GetIpcNewDataIndicationPeriod (strNewDataPeriod_p)
        {
